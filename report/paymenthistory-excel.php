...
$objPHPExcel->getProperties()->setCreator("Mundo Satelital v4.1")
							 ->setLastModifiedBy("Mundo Satelital v4.1")
							 ->setTitle("Products - Mundo Satelital v4.1")
...
$sheet->setCellValue('A1', 'Historial de pagos - Mundo Satelital')
