...
$objPHPExcel->getProperties()->setCreator("Mundo Satelital v3.1")
							 ->setLastModifiedBy("Mundo Satelital v3.1")
							 ->setTitle("Products - Mundo Satelital v3.1")
							 ->setSubject("Mundo Satelital Products Report")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Reporte de Inventario - Mundo Satelital')
->setCellValue('A2', 'Id')
