...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Mundo Satelital | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">MUNDO<b>SATELITAL</b></span>
        </a>
   ...
   <?php endif; ?>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2023 <a href="#" target="_blank">Kevin Aviles</a></strong>
      </footer>
      <?php else:?>
        <?php if(isset($_GET["view"]) && $_GET["view"]=="clientaccess"):?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">MUNDO<b>SATELITAL</b></a>
      </div><!-- /.login-logo -->
