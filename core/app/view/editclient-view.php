...
<div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=updateclient" role="form">
            ...
            <div class="form-group">
                <label for="inputEmail1" class="col-lg-2 control-label">CC/RUT</label>
                <div class="col-md-6">
                    <input type="text" name="no" value="<?php echo $user->no;?>" class="form-control" id="no" placeholder="CC/RUT">
                </div>
            </div>
            <div class="form-group">
            ...
            <!-- Nuevos campos IMEI y Teléfono GPS -->
            <div class="form-group">
                <label for="inputEmail1" class="col-lg-2 control-label">GPS Imei</label>
                <div class="col-md-6">
                    <input type="text" name="gpsimei" value="<?php echo $user->gpsimei;?>" class="form-control" id="inputEmail1" placeholder="IMEI">
                </div>
            </div>
            <div class="form-group">
                <label for="inputEmail1" class="col-lg-2 control-label">Teléfono GPS</label>
                <div class="col-md-6">
                    <input type="text" name="gpstel" value="<?php echo $user->gpstel;?>" class="form-control" id="inputEmail1" placeholder="Teléfono GPS">
                </div>
            </div>
            <!-- Fin de nuevos campos IMEI y Teléfono GPS -->
            <div class="form-group">
