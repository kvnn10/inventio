                    ...
                    <div class="box-body">
                        <table class="table table-bordered datatable table-hover">
                            <thead>
                                ...
                                <th>Telefono</th>
                                <th>Credito</th>
                                <th>IMEI</th> <!-- Nuevo campo IMEI -->
                                <th>Telefono GPS</th> <!-- Nuevo campo Teléfono GPS -->
                                <th></th>
                            </thead>
                            <?php
                            foreach($users as $user){
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $user->gpsimei; ?></td> <!-- Mostrar IMEI -->
                                    <td><?php echo $user->gpstel; ?></td> <!-- Mostrar Teléfono GPS -->
...
<script type="text/javascript">
    function thePDF() {
        ...
        var columns = [
            {title: "Id", dataKey: "id"}, 
            {title: "CC/RUT", dataKey: "no"}, 
            {title: "Nombre completo", dataKey: "name"}, 
            {title: "Direccion", dataKey: "address"}, 
            {title: "Email", dataKey: "email"}, 
            {title: "Telefono", dataKey: "phone"}, 
            {title: "IMEI", dataKey: "gpsimei"}, // Nuevo campo IMEI
            {title: "Telefono GPS", dataKey: "gpstel"}, // Nuevo campo Teléfono GPS
        ];
        var rows = [
            <?php foreach($users as $product): ?>
                {
                    ...
                    "gpsimei": "<?php echo $product->gpsimei; ?>", // Nuevo campo IMEI
                    "gpstel": "<?php echo $product->gpstel; ?>", // Nuevo campo Teléfono GPS
                },
            <?php endforeach; ?>
        ];
