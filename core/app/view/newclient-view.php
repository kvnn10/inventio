...
<div class="box box-primary"><br>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="no" class="form-control" id="no" placeholder="CC/RUT">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="gpsimei" class="form-control" id="gpsimei" placeholder="Gps Imei">
    </div>
  </div>
  
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">GPS Telefono</label>
    <div class="col-md-6">
      <input type="text" name="gpstel" class="form-control" id="gpstel" placeholder="Gps Telefono">
    </div>
  </div>
